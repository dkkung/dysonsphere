...
```
Generated by username with analysis.py using Python vX.Y.Z on YYYYMMDD at HH:MM:SS UTC using altair vX.Y.Z / dysonsphere vX.Y.Z.
```
...
# description field: "Figure 1\nGenerated by username with analysis.py using Python ..."
```
