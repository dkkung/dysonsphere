...
```python
mark_strip(df: pl.DataFrame | Any, xCol: str, yCol: str, categories: list[str], *, scatter: str = 'jitter', palette: list[str] | None = None, markSize: int | None = None, markOpacity: float | None = None, spread: float | None = None, legend: bool = False, xLabelAngle: float | None = None, errorbars: bool = True, errorbarExtent: str = 'sem', yTitle: str | None | _UnsetType = _UNSET, xTitle: str | None | _UnsetType = _UNSET)
```
